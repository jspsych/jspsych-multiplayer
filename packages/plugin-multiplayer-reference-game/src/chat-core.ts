/**
 * Pure, framework-free core for the integrated chat panel: the message data model and the
 * merge/append logic. Mirrored self-contained from `plugin-multiplayer-chat/src/chat-core.ts` (the
 * repo deliberately keeps each package self-contained rather than cross-importing).
 *
